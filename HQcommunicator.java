...
//  Each robot should keep an instance of this class as a private 
//  member called 'comms'.
//
//   Setup:
...
public class HQcommunicator{
	...
	public int getMessage(int robotID){
	    updateInternalClock();
	    int message = rc.readBroadcast(assignedChannel*(robotID+1));
	...
	public void sendMessage(int message, int robotID){
		updateInternalClock();
		rc.broadcast(assignedChannel*(robotID+1),coder.encode(message));
	}
}
